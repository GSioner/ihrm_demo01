    ...
    <div class="app-container">
      <el-card>
        ...
        <el-row type="flex" justify="end" style="margin-top: 20px">
          <el-button v-print="printObj" size="mini" type="primary">打印信息</el-button>
        </el-row>
        <!-- 员工基本信息 -->
...
export default {
  ...
  // 组件更新
  methods: {
    async getStaffInfomation() {
      this.formData = await getStaffInfomation(this.userId) // 获取个人基本信息
    },
    async getStaffJobInfo() {
      const userInfo = await getStaffPersonalInfo(this.userId)
      const jobInfo = await getStaffJobInfo(this.userId) // 获取个人基本信息
